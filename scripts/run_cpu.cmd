...
%PY% -c "import os, sys; sys.path.insert(0, os.path.abspath('NeuroMita.pyz')); from utils.uv_sync import UvSync; UvSync().apply({'core','backend-cpu','asr-gigaam'})" || goto :fail
%PY% NeuroMita.pyz
goto :eof
