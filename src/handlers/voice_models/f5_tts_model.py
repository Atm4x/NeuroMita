    ...
    MODEL_CONFIGS = [
        {
            ...
            "intents": [t("handlers.voice_models.f5_tts.models.high.intent_emotion"), t("handlers.voice_models.f5_tts.models.high.intent_quality")],
            "description": t("handlers.voice_models.f5_tts.models.high.high_description"),
            "settings": [
                {"key": "speed", "label": t("handlers.voice_models.f5_tts.models.high.speed_label"), "type": "entry", "options": {"default": "1.0"},
                 "help": t("handlers.voice_models.f5_tts.models.high.speed_help")},
                {"key": "nfe_step", "label": t("handlers.voice_models.f5_tts.models.high.nfe_step_label"), "type": "entry", "options": {"default": "32"},
                 "help": t("handlers.voice_models.f5_tts.models.high.nfe_step_help")},
                {"key": "remove_silence", "label": t("handlers.voice_models.f5_tts.models.high.remove_silence_label"), "type": "checkbutton", "options": {"default": True},
                 "help": t("handlers.voice_models.f5_tts.models.high.remove_silence_help")},
                {"key": "seed", "label": t("handlers.voice_models.f5_tts.models.high.seed_label"), "type": "entry", "options": {"default": "0"},
                 "help": t("handlers.voice_models.f5_tts.models.high.seed_help")},
                {"key": "volume", "label": t("handlers.voice_models.f5_tts.models.high.volume_label"), "type": "entry", "options": {"default": "1.0"},
                 "help": t("handlers.voice_models.f5_tts.models.high.volume_help")},
                {"key": "use_ruaccent", "label": t("handlers.voice_models.f5_tts.models.high.use_ruaccent_label"), "type": "checkbutton", "options": {"default": False},
                 "help": t("handlers.voice_models.f5_tts.models.high.use_ruaccent_help")}
            ]
        },
        {
            "id": "high+low",
            ...
            "size_gb": 7,
            "languages": ["Russian", "English"],
            "intents": [t("handlers.voice_models.f5_tts.models.high_low.intent_emotion_plus"), t("handlers.voice_models.f5_tts.models.high_low.intent_voice_conversion")],
            "description": t("handlers.voice_models.f5_tts.models.high_low.high_low_description"),
            "settings": [
                {"key": "f5rvc_f5_device", "label": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_f5_device_label"), "type": "combobox",
                 "options": {"values": ["cuda", "cpu"], "default": "cuda"},
                 "help": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_f5_device_help")},
                {"key": "f5rvc_rvc_device", "label": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_rvc_device_label"), "type": "combobox",
                 ...
                 "help": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_rvc_device_help")},

                {"key": "f5rvc_f5_speed", "label": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_f5_speed_label"), "type": "entry", "options": {"default": "1.0"},
                 "help": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_f5_speed_help")},
                {"key": "f5rvc_f5_nfe_step", "label": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_f5_nfe_step_label"), "type": "entry", "options": {"default": "32"},
                 "help": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_f5_nfe_step_help")},
                {"key": "f5rvc_f5_seed", "label": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_f5_seed_label"), "type": "entry", "options": {"default": "0"},
                 "help": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_f5_seed_help")},
                {"key": "f5rvc_f5_remove_silence", "label": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_f5_remove_silence_label"), "type": "checkbutton", "options": {"default": True},
                 "help": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_f5_remove_silence_help")},

                {"key": "f5rvc_rvc_pitch", "label": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_rvc_pitch_label"), "type": "entry", "options": {"default": "0"},
                 "help": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_rvc_pitch_help")},
                {"key": "f5rvc_index_rate", "label": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_index_rate_label"), "type": "entry", "options": {"default": "0.75"},
                 "help": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_index_rate_help")},
                {"key": "f5rvc_protect", "label": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_protect_label"), "type": "entry", "options": {"default": "0.33"},
                 "help": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_protect_help")},
                {"key": "f5rvc_filter_radius", "label": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_filter_radius_label"), "type": "entry", "options": {"default": "3"},
                 "help": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_filter_radius_help")},
                {"key": "f5rvc_rvc_rms_mix_rate", "label": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_rvc_rms_mix_rate_label"), "type": "entry", "options": {"default": "0.5"},
                 "help": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_rvc_rms_mix_rate_help")},
                {"key": "f5rvc_is_half", "label": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_is_half_label"), "type": "combobox",
                 "options": {"values": ["True", "False"], "default": "True"},
                 "help": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_is_half_help")},
                {"key": "f5rvc_f0method", "label": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_f0method_label"), "type": "combobox",
                 "options": {"values": ["pm", "rmvpe", "crepe", "harvest", "fcpe", "dio"], "default": "rmvpe"},
                 "help": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_f0method_help")},
                {"key": "f5rvc_use_index_file", "label": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_use_index_file_label"), "type": "checkbutton", "options": {"default": True},
                 "help": t("handlers.voice_models.f5_tts.models.high_low.f5rvc_use_index_file_help")},

                {"key": "volume", "label": t("handlers.voice_models.f5_tts.models.high_low.volume_label"), "type": "entry", "options": {"default": "1.0"},
                 "help": t("handlers.voice_models.f5_tts.models.high_low.volume_help")},
                {"key": "f5rvc_use_ruaccent", "label": t("handlers.voice_models.f5_tts.models.high_low.use_ruaccent_label"), "type": "checkbutton", "options": {"default": False},
                 "help": t("handlers.voice_models.f5_tts.models.high_low.use_ruaccent_help")}
            ]
        }
    ]
